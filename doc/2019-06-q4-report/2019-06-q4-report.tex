...
\textbf{M2.1: Demonstrate SaltProc}, the challenges we currently face, and 
the steps toward the Task 2 objectives.
...
\end{quote}
        ...
        Herein we demonstrated the following 
capabilities of SaltProc v0.2.0+:
\begin{enumerate}
	...
	processing system. For demonstration proposes, SaltProc v0.2.0+ used 
