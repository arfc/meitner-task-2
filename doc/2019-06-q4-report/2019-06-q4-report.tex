...
designs usually propose high-density reactor graphite. Zirconium hydride 
offers a much 
...
at \gls{ORNL} in a program that started in 1950s.}), which is highly resistant 
to corrosion in various molten salt environments. 
...
\gls{SVF} in the core is parameter similar to wide-used moderator-to-fuel 
...
\paragraph{Dynamic moderator-to-fuel ratio:} The \gls{TAP} major feature is 
